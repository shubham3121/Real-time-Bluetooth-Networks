...
//***YOU IMPLEMENT THIS FUNCTION*****
									int32_t status;
										...
										tcbs[0].next = &tcbs[1];	// 1 points to 2
										tcbs[1].next = &tcbs[2];	// 2 points to 3
										tcbs[2].next = &tcbs[3];	// 3 points to 4
										tcbs[3].next = &tcbs[0];	// 4 points to 0
